...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'qcm', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_042e17a4b640b23c1c8c264c2828624a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_042e17a4b640b23c1c8c264c2828624a');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_042e17a4b640b23c1c8c264c2828624a');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Qcm\\QcmBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Utilisateurs\\UtilisateursBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Dex\\DexBundle\\Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Qcm\\QcmBundle\\Entity');
        $f->addDriver($e, 'Utilisateurs\\UtilisateursBundle\\Entity');
        $f->addDriver($e, 'Dex\\DexBundle\\Entity');
        ...
        $g->setEntityNamespaces(array('QcmBundle' => 'Qcm\\QcmBundle\\Entity', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity', 'DexBundle' => 'Dex\\DexBundle\\Entity'));
        ...
        $g->addCustomStringFunction('MD5', 'Qcm\\QcmBundle\\DQL\\MD5Function');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '28ffb19f0620008a72628d0a662809b904c951e5');
    }
    ...
    {
        $this->services['fos_rest.request.param_fetcher'] = $instance = new \FOS\RestBundle\Request\ParamFetcher($this->get('fos_rest.request.param_fetcher.reader'), NULL, $this->get('fos_rest.violation_formatter'), $this->get('validator', ContainerInterface::NULL_ON_INVALID_REFERENCE), false);
    ...
    protected function getJmsSerializerService()
    {
        ...
        $this->services['jms_serializer'] = $instance = new \JMS\Serializer\Serializer($a, $this->get('jms_serializer.handler_registry'), $this->get('jms_serializer.unserialize_object_constructor'), new \PhpCollection\Map(array('json' => $this->get('jms_serializer.json_serialization_visitor'), 'xml' => $this->get('jms_serializer.xml_serialization_visitor'), 'yml' => $this->get('jms_serializer.yaml_serialization_visitor'))), new \PhpCollection\Map(array('json' => $this->get('jms_serializer.json_deserialization_visitor'), 'xml' => $this->get('jms_serializer.xml_deserialization_visitor'))), $b, NULL, NULL);
    ...
    {
        $this->services['jms_serializer.json_serialization_visitor'] = $instance = new \JMS\Serializer\JsonSerializationVisitor($this->get('jms_serializer.naming_strategy'), $this->get('jms_serializer.accessor_strategy.default'));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Qcm\\QcmBundle' => ($this->targetDirs[3].'\\src\\Qcm\\QcmBundle/Resources/config/serializer'), 'FOS\\UserBundle' => 'C:/wamp/www/QCMV2/app/serializer/FOSUserBundle'));
    ...
    {
        $this->services['jms_serializer.xml_serialization_visitor'] = $instance = new \JMS\Serializer\XmlSerializationVisitor($this->get('jms_serializer.naming_strategy'), $this->get('jms_serializer.accessor_strategy.default'));
    ...
    {
        return $this->services['jms_serializer.yaml_serialization_visitor'] = new \JMS\Serializer\YamlSerializationVisitor($this->get('jms_serializer.naming_strategy'), $this->get('jms_serializer.accessor_strategy.default'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Utilisateurs\UtilisateursBundle\Redirection\AfterLoginRedirection A Utilisateurs\UtilisateursBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Utilisateurs\UtilisateursBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Utilisateurs\UtilisateursBundle\Redirection\AfterLogoutRedirection A Utilisateurs\UtilisateursBundle\Redirection\AfterLogoutRedirection instance.
     */
    protected function getRedirect_After_LogoutService()
    {
        return $this->services['redirect.after.logout'] = new \Utilisateurs\UtilisateursBundle\Redirection\AfterLogoutRedirection($this->get('router'), $this->get('security.context'));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Dex\\DexBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Qcm\\QcmBundle/Resources/views'), 'Qcm');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Dex\\DexBundle/Resources/views'), 'Dex');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('28ffb19f0620008a72628d0a662809b904c951e5');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'fr',
            'secret' => '28ffb19f0620008a72628d0a662809b904c951e5',
            ...
            'kernel.secret' => '28ffb19f0620008a72628d0a662809b904c951e5',
