...
Paginator.prototype = {
    nextPage: function (callback) {
        if (this.isLastPage()) {
            ...
            console.log('lasss ',lastKey)
            // debugger;
            var pri = lastKey ? null : undefined;
            this.ref.startAt(pri, lastKey).limit(this.limit + (lastKey ? 1 : 0)).once('value', this._process.bind(this, {
                    cb: callback,
                    dir: 'next',
                    key: lastKey
                }));
...
var paginator = new Paginator(refQuestion, 3);
moveForward();
